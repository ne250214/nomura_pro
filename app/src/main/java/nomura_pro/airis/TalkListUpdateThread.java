 ...
 */
public class TalkListUpdateThread extends AsyncTask<String, Void, String> {
    ...
    public TalkListUpdateThread(Activity activity, SharedPreferences pref, String room_id, long last_updata, int group_id, String name, String screen) {
