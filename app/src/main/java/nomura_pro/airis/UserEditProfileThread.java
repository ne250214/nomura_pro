 ...
 */
public class UserEditProfileThread extends AsyncTask<String, Void, String> {

    private Activity m_Activity;
    SharedPreferences m_pref;

    public UserEditProfileThread(Activity activity,SharedPreferences pref) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            // サーバーへ接続
            connection = new Socket(CommonUtilities.SERVER_URL, CommonUtilities.SERVER_PORT);
            ...
            pw.println("user edit_profile " + m_pref.getString("id", "null") +" "+ m_pref.getString("session", "null") +" "+profile);
    ...
    protected void onPostExecute(String param) {
        ...
        if (my_user_data[0].equals("accept")){
            ...
            editor.putString("profile", my_user_data[1]);
