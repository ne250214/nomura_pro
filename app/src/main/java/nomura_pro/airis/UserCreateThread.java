...
public class UserCreateThread extends AsyncTask<String, Void, String> {

    private Activity m_Activity;
    SharedPreferences m_pref;

    public UserCreateThread(Activity activity,SharedPreferences pref) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            final String regId = gcm.register(CommonUtilities.SENDER_ID);
            message = SocketConnect.connect("user create " + name + " " + address + " " + pass + " " + profile + " " + user_id + " " + regId);
    ...
    protected void onPostExecute(String param) {
        ...
        if (my_user_data[0].equals("accept")){
            ...
            for(int i=1;i<=6;i++){
                my_user_data[i] = my_user_data[i].replaceAll(CommonUtilities.BLANK_CODE," ");
            }
