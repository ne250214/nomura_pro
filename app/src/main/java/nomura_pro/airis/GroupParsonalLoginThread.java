 ...
 */
public class GroupParsonalLoginThread extends AsyncTask<String, Void, String> {
    ...
    public GroupParsonalLoginThread(Activity activity,SharedPreferences pref,int interlocutor_id) {
