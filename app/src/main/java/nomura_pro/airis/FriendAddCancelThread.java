...
/**
 * Created by ne250214 on 15/09/26.
 */
public class FriendAddCancelThread extends AsyncTask<String, Void, String> {

    private Activity m_Activity;
    SharedPreferences m_pref;

    public FriendAddCancelThread(Activity activity,SharedPreferences pref) {
    ...
    protected String doInBackground(String... params) {
        ...
        message = SocketConnect.connect("friend add_cancel " + m_pref.getString("id", "null") +" "+ m_pref.getString("session", "null") +" "+screen);
