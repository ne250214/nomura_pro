...
/**
 * Created by ne250214 on 15/10/01.
 */
public class FriendApproveThread  extends AsyncTask<String, Void, String> {

    private Activity m_Activity;
    SharedPreferences m_pref;

    public FriendApproveThread(Activity activity,SharedPreferences pref) {
